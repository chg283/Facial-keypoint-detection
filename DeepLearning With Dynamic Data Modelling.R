...
testing.data.model1.hex<-as.h2o(testing.data.model1[,2:2305])
...
for (i in 1:30) {
  ...
  training.data.model1.hex<-as.h2o(training.data.model1[complete.cases(training.data.model1[,i]),])
...
testing.data.model2.hex<-as.h2o(testing.data.model2[,2:2305])
...
for (i in 1:30) {
  ...
  training.data.model2.hex<-as.h2o(training.data.model2[complete.cases(training.data.model2[,i]),])
