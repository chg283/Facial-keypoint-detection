...
data.dir   <- '~/Desktop/Facial-KeyPoint-Detection/DataSets/'
...
save(training.data, testing.data, file='randomForestInitial.Rd')

load('randomForestInitial.Rd')
...
#crete H2O models
model_1 <- h2o.randomForest(x = c(31:9246), y = 1,  training_frame = training.data.hex)
model_2 <- h2o.randomForest(x = c(1:1,31:9246), y = 2,  training_frame = training.data.hex)
model_3 <- h2o.randomForest(x = c(1:2,31:9246), y = 3,  training_frame = training.data.hex)
model_4 <- h2o.randomForest(x = c(1:3,31:9246), y = 4 , training_frame = training.data.hex)
model_5 <- h2o.randomForest(x = c(1:4,31:9246), y = 5 , training_frame = training.data.hex)
model_6 <- h2o.randomForest(x = c(1:5,31:9246), y = 6 , training_frame = training.data.hex)
model_7 <- h2o.randomForest(x = c(1:6,31:9246), y = 7 , training_frame = training.data.hex)
model_8 <- h2o.randomForest(x = c(1:7,31:9246), y = 8 , training_frame = training.data.hex)
model_9 <- h2o.randomForest(x = c(1:8,31:9246), y = 9 , training_frame = training.data.hex)
model_10 <- h2o.randomForest(x = c(1:9,31:9246), y = 10 , training_frame = training.data.hex)
model_11 <- h2o.randomForest(x = c(1:10,31:9246), y = 11 , training_frame = training.data.hex)
model_12 <- h2o.randomForest(x = c(1:11,31:9246), y = 12 , training_frame = training.data.hex)
model_13 <- h2o.randomForest(x = c(1:12,31:9246), y = 13 , training_frame = training.data.hex)
model_14 <- h2o.randomForest(x = c(1:13,31:9246), y = 14 , training_frame = training.data.hex)
model_15 <- h2o.randomForest(x = c(1:14,31:9246), y = 15 , training_frame = training.data.hex)
model_16 <- h2o.randomForest(x = c(1:15,31:9246), y = 16 , training_frame = training.data.hex)
model_17 <- h2o.randomForest(x = c(1:16,31:9246), y = 17 , training_frame = training.data.hex)
model_18 <- h2o.randomForest(x = c(1:17,31:9246), y = 18 , training_frame = training.data.hex)
model_19 <- h2o.randomForest(x = c(1:18,31:9246), y = 19 , training_frame = training.data.hex)
model_20 <- h2o.randomForest(x = c(1:19,31:9246), y = 20 , training_frame = training.data.hex)
model_21 <- h2o.randomForest(x = c(1:20,31:9246), y = 21 , training_frame = training.data.hex)
model_22 <- h2o.randomForest(x = c(1:21,31:9246), y = 22 , training_frame = training.data.hex)
model_23 <- h2o.randomForest(x = c(1:22,31:9246), y = 23 , training_frame = training.data.hex)
model_24 <- h2o.randomForest(x = c(1:23,31:9246), y = 24 , training_frame = training.data.hex)
model_25 <- h2o.randomForest(x = c(1:24,31:9246), y = 25 , training_frame = training.data.hex)
model_26 <- h2o.randomForest(x = c(1:25,31:9246), y = 26 , training_frame = training.data.hex)
model_27 <- h2o.randomForest(x = c(1:26,31:9246), y = 27 , training_frame = training.data.hex)
model_28 <- h2o.randomForest(x = c(1:27,31:9246), y = 28 , training_frame = training.data.hex)
model_29 <- h2o.randomForest(x = c(1:28,31:9246), y = 29 , training_frame = training.data.hex)
model_30 <- h2o.randomForest(x = c(1:29,31:9246), y = 30 , training_frame = training.data.hex)
...
save(model_1,model_2,model_3,model_4,model_5,model_6,model_7,model_8,model_9,model_10,
     ...
     model_21,model_22,model_23,model_24,model_25,model_26,model_27,model_28,model_29,model_30
      , file='randomForestModels_nafill.Rd')

load('randomForestModels_nafill.Rd')
...
save(predicted.test.data, file='randomForestPredictedResults_nafill.Rd')

load('randomForestPredictedResults_nafill.Rd')
...
submit_file  <- paste0(data.dir, 'submission_H2O_randomForest_nafill.csv')
