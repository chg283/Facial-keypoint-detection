...
#save and load data in R .Initial data from source file after cleaning (Omitting the NA's)
save(training.data,testing.data ,file='H2O_Dynamic_Initial2.Rd')

load('H2O_Dynamic_Initial2.Rd')
...
#save and load data in R .Initial data from source file after cleaning (Omitting the NA's)
save(predicted.testing.data1,predicted.testing.data2 ,file='H2O_Dynamic_Predictions2.Rd')
...
#Multiply the nsub(4) by 2 

submit_file  <- paste0(data.dir, 'submission_H2O_deeplearning_2Model-48x48.csv')
